...
public:
  ...
  RangerMockSonar(unsigned int fov, unsigned int res, ranger::SensorPose pose, std::vector<double>);
  RangerMockSonar(unsigned int fov, unsigned int res, int offset, std::vector<double> mockData);
